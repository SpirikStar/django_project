# Generated by Django 5.0 on 2024-01-31 17:42
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='product',
            name='currency',
            field=models.CharField(choices=[('RU', 'Рублей'), ('US', 'Доллары'), ('CHINA', 'Юани'), ('EU', 'Евро')], default='RU', max_length=10, verbose_name='Валюта'),
        ),
